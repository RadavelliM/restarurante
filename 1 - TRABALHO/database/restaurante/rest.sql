...
(
    ...
    Usuario_tipo VARCHAR(2) -- 0 = cliente, 1 = funcionario, 2 = gerente
)
...
ALTER TABLE Pedido ADD CONSTRAINT FK_Usuario_Pedido FOREIGN
KEY(Usuario_id) REFERENCES Usuarios (Usuario_id)

ALTER TABLE Pedido ADD CONSTRAINT FK_Mesa_Pedido FOREIGN
KEY(Mesa_numero) REFERENCES Mesa (Mesa_numero)
...
KEY(Pedido_id) REFERENCES Pedido (Pedido_id)
